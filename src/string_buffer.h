...
GUMBO_API void gumbo_string_buffer_init(
...
GUMBO_API void gumbo_string_buffer_reserve(struct GumboInternalParser* parser,
...
GUMBO_API void gumbo_string_buffer_clear(
    struct GumboInternalParser* parser, GumboStringBuffer* input);

// Deallocates this GumboStringBuffer.
GUMBO_API void gumbo_string_buffer_destroy(
